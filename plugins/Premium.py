    ...
    if len(message.command) == 2:
        ...
        if await db.remove_premium_access(user_id):
            ...
            await client.send_message(
                chat_id=user_id,
                text=f"<b>ʜᴇʏ {user.mention},\n\n𝒀𝒐𝒖𝒓 𝑷𝒓𝒆𝒎𝒊𝒖𝒎 𝑨𝒄𝒄𝒆𝒔𝒔 𝑯𝒂𝒔 𝑩𝒆𝒆𝒏 𝑹𝒆𝒎𝒐𝒗𝒆𝒅. 𝑻𝒉𝒂𝒏𝒌 𝒀𝒐𝒖 𝑭𝒐𝒓 𝑼𝒔𝒊𝒏𝒈 𝑶𝒖𝒓 𝑺𝒆𝒓𝒗𝒊𝒄𝒆 😊. 𝑪𝒍𝒊𝒄𝒌 𝑶𝒏 /plan 𝑻𝒐 𝑪𝒉𝒆𝒄𝒌 𝑶𝒖𝒓 𝑶𝒕𝒉𝒆𝒓 𝑷𝒍𝒂𝒏𝒔.\n\n<blockquote>ನಿಮ್ಮ ಸೇವೆಯ ಅವಧಿ ಮುಗಿದಿದೆ. ನಮ್ಮ ಸೇವೆಯನ್ನು ಬಳಸಿದ್ದಕ್ಕಾಗಿ ಧನ್ಯವಾದಗಳು 😊. ನೀವು ಮತ್ತೆ ಸೇವೆಯನ್ನು ಪಡೆಯಲು ಬಯಸಿದರೆ, ಯೋಜನೆಗಳ ಕುರಿತು ವಿವರಗಳಿಗಾಗಿ /plan ಗೆ ಭೇಟಿ ನೀಡಿ. ।</blockquote></b>"
            )
        else:
