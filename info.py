...
# ============================
SESSION = environ.get('SESSION', 'Movie_Hobbies')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002262572539'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002324917372'))  # Bin channel id (make sure bot is admin)
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002420970943'))  # Notification of those who verify will be sent to your channel
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002420970943').split()]
...
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002160963221').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002160963221').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://vinod974323:OrPcFCkIK7z4eOdj@cluster0.okuo1q3.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://vinod974323:48PQkZp2EprOueRN@cluster0.uu3dav9.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
DEENDAYAL_VERIFIED_LOG = int(environ.get('DEENDAYAL_VERIFIED_LOG', '-1002420826240'))  # Log channel id (make sure bot is admin)
...
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'http://linkshortify.com')
SHORTLINK_API = environ.get('SHORTLINK_API', 'd200e6d92af0bf242b9d25fce8c9b7023bb7720e')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Link_06')  # Tutorial video link for opening shortlink website
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))

# ============================
# Channel & Group Links Configuration
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+ar_fv-c6BnUzNmU1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+MdeAR1xBO98xN2U1')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/+Cz1vD1yu4YxhYmI1')
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/+NC3HXVTwHL41OGU1')
