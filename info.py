...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Link_06/5')  # Tutorial video link for opening shortlink website
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Arisu_s_k')
...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '1289890372').split()]
